...
<template>
    <div v-if="movie" class="dialog-overlay" @click="close">
        <div class="dialog-content" @click.stop>
            ...
            <p class="desc">
                The file <span class="mono">{{ movie.fileName }}</span> was incorrectly identified as
            ...
            >
                ...
                <div>
                    ...
                    <span style="opacity: 0.9; font-size: 12px; line-height: 1.4; display: block"
                        >Our parser cannot always guess missing punctuation (like apostrophes in "Ocean's" or colons).
                        Try adding them manually, or simplifying the query if the exact match fails.</span
                    >
                </div>
            </div>

            <div class="search-row">
                <input type="text" v-model="searchQuery" placeholder="Search by title..." @keyup.enter="search" />
            ...
            <div class="results-container">
                ...
                <div v-else-if="hasSearched && searchResults.length === 0" class="message">
                ...
                <div class="results-grid" v-if="searchResults.length > 0">
                    ...
                    >
                        <img
                            v-if="res.poster && res.poster !== 'N/A'"
                            :src="res.poster"
                            :alt="res.title"
                            class="res-poster"
                        />
