        ...
        <div class="dialog-content" @click.stop>
            ...
            <div class="split-layout">
                ...
                <div class="info-col">
                    ...
                    <div class="meta-row">
                        <span v-if="movie.year && movie.year !== 'N/A'" class="meta-item"
                            ><Calendar :size="14" /> {{ movie.year }}</span
                        >
                        <span v-if="movie.runtime && movie.runtime !== 'N/A'" class="meta-item"
                            ><Clock :size="14" /> {{ movie.runtime }}</span
                        >
                        <span v-if="movie.rated && movie.rated !== 'N/A'" class="meta-item boxed">{{
                            movie.rated
                        }}</span>
                    </div>
                    ...
                    <div class="details-grid">
                        ...
                        <div class="detail-cell span-2" v-if="movie.fileName">
                            ...
                            <span
                                ...
                                @click="
                                    movie.importSource === 'imdb'
                                        ? invoke('open_external', {url: movie.fileName})
                                        : showInExplorer()
                                "
                            >
                                {{ movie.fileName }}
                    ...
                    <div
                        ...
                        v-if="ratingsList.length > 0 || (movie.imdbRating && movie.imdbRating !== 'N/A')"
                    >
                        <h3>Ratings</h3>
                        <div class="ratings-row">
                            <div class="rating-box" v-if="movie.imdbRating && movie.imdbRating !== 'N/A'">
                                ...
                                <div class="r-value">
                                    <Star :size="14" fill="currentColor" class="star" /> {{ movie.imdbRating }}
                                    <span class="r-votes" v-if="movie.imdbVotes && movie.imdbVotes !== 'N/A'"
...
.outline-btn.destructive {
    color: #ef4444;
    border-color: rgba(239, 68, 68, 0.3);
}
.outline-btn.destructive:hover {
