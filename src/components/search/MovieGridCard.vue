        ...
        <div class="hover-overlay">
            ...
            <div class="menu-container" @click.stop>
                ...
                <div v-if="isMenuOpen" class="dropdown-menu">
                    <button class="dropdown-item" @click="openDetails"><Info :size="16" /> View Details</button>
                    <button class="dropdown-item" @click="openWrongMovie"><RefreshCw :size="16" /> Wrong Movie?</button>
